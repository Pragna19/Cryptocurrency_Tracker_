...
function THT() {
    ...
    useEffect(()=>{
        axios.get('https://min-api.cryptocompare.com/data/price?fsym=tht&tsyms=USD,JPY,EUR')
    ...
    return (
        <div style={{background:'#F6FFEE'}}>
            ...
            <Navbar style={{position:"absolute",left:"0px",right:"0px",top:"0px",background: "#F6FFEE"}}>
                <Container>
                    <Navbar.Brand href="#home" style={{color:"#676565",fontWeight:"400",fontStyle:"normal",fontFamily:"Fredoka One",fontSize:"48px",lineHeight:"58px"}}>Tether</Navbar.Brand>
                </Container>
            </Navbar>
            <br></br>
