    ...
    return (
        <div className="login" style={{padding:"0%",margin:"0%",background: "#152238"}}>
            ...
            <div style={{margin:"0%",padding:"10px",background: "#152238",zIndex:2,top:"50%",left:"50%",textAlign:"center",transform:"translate(-50%,-50%)",zIndex:2,position:"absolute",borderRadius:"66px"}}>
                <h1 style={{color:"white",fontFamily:"Fredoka One",fontWeight:400,fontSize:"64px",lineHeight:"77px",textAlign:"center"}}>Register</h1>
                    <form action="POST">
                        <br></br>
                        ...
                        <br></br>
                        <br></br>
                        <input style={{borderRadius:"50px",color:"black",fontFamily:"Ubuntu",fontStyle:"normal",fontWeight:"200",fontSize:"20px",height:"50px",width:"730px",textAlign:"center",backgroundColor:"#0091ab"}} type="password" onChange={(e) => { setPassword(e.target.value) }} placeholder="Password" />
                        <br></br>
                        <br></br>
